...
module "kinesis_stream_es" {
    source = "git::https://github.com/vishalbhogate/terraform-aws-kinesis-stream-es-default.git"
...
Apache 2 Licensed. See [LICENSE](https://github.com/vishalbhogate/terraform-aws-kinesis-stream-es/blob/master/LICENSE) for full details.
